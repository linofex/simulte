...
#ifndef __SOCKETMANAGER_normal_H
#define __SOCKETMANAGER_normal_H
...
class SocketManager_normal : public cObject, public TCPSocket::CallbackInterface
{
  protected:
    LocationService_test_normal *service;
  ...
  public:
    ...
    SocketManager_normal() { sock = nullptr; service = nullptr; }
    virtual ~SocketManager_normal() {}

    // internal: called by TCPSrvHostApp after creating this module
    virtual void init(LocationService_test_normal *serv, TCPSocket *socket) { service = serv; sock = socket; }
