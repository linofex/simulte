...
#include "apps/mec/PerformanceEvaluation/MeService/LocationService_test_binomial.h"
...
Define_Module(LocationService_test_binomial);


LocationService_test_binomial::LocationService_test_binomial():LocationService(){
}

void LocationService_test_binomial::initialize(int stage)
{
...
void LocationService_test_binomial::handleMessage(cMessage *msg)
{
    if (msg->isSelfMessage()) {
           ...
           //        std::cout <<"New connection from: " << socket->getRemoteAddress() << " and port " << socket->getRemotePort() << std::endl ;
               ...
               SocketManager_binomial *proc =
                   check_and_cast<SocketManager_binomial *>(inet::utils::createOne(serverThreadClass));
...
bool LocationService_test_binomial::manageRequest()
{
...
void LocationService_test_binomial::removeConnection(SocketManager_binomial *connection)
{
    // remove socket
...
LocationService_test_binomial::~LocationService_test_binomial(){}
