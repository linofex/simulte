...
#ifndef _LOCATIONSERVICE_TEST_BINOMIAL_H
#define _LOCATIONSERVICE_TEST_BINOMIAL_H
...
class Location;
class SocketManager_binomial;

class LocationService_test_binomial: public LocationService
{
  private:
    int numApps_;
    double prob_;
...
//    virtual bool handleSubscriptionType(cMessage *msg);
    ...
    virtual ~LocationService_test_binomial();


};


#endif // ifndef _LocationService_test_binomial_TEST_H
