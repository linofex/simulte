...
#ifndef __SOCKETMANAGER_BINOMIAL_H
#define __SOCKETMANAGER_BINOMIAL_H

#include "apps/mec/MeServices/MeServiceBase/MeServiceBase.h"
...
class SocketManager_binomial : public cObject, public TCPSocket::CallbackInterface
{
  protected:
    LocationService_test_binomial *service;
  ...
  public:
    ...
    SocketManager_binomial() { sock = nullptr; service = nullptr; }
    virtual ~SocketManager_binomial() {}

    // internal: called by TCPSrvHostApp after creating this module
    virtual void init(LocationService_test_binomial *serv, TCPSocket *socket) { service = serv; sock = socket; }
